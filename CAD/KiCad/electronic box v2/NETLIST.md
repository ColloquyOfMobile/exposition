...
|---|---|---|---|---|---|---|---|
| **female1** | 160 Hz | T1 | `D11` | R101 = R102 = 2K2 | C101 = C102 = 470nF | R103 = 100R | TP1 |
| **female2** | 400 Hz | T3 | `D5` | R201 = R202 = 2K | C201 = C202 = 220nF | R203 = 100R | TP2 |
| **female3** | 1000 Hz | T4 | `D6` | R301 = R302 = 1K2 | C301 = C302 = 150nF | R303 = 100R | TP3 |
| **male1** | 2500 Hz | T5 | `D46` | R401 = R402 = 1K8 | C401 = C402 = 47nF | R403 = 100R | TP4 |
| **male2** | 6250 Hz | T2 | `D10` | R501 = R502 = 2K2 | C501 = C502 = 10nF | R503 = 100R | TP5 |
...
|---|---|---|---|---|---|
| **female1** | U1 | module 0 | `A0` | band 1 | TP11 |
| **female2** | U2 | module 1 | `A1` | band 2 | TP12 |
| **female3** | U3 | module 2 | `A2` | band 3 | TP13 |
| **male1** | U4 | module 3 | `A3` | band 4 | TP14 |
| **male2** | U5 | module 4 | `A4` | band 5 | TP15 |
...
| `AGND` | 33 | JP1.1, C101.2, C102.2, JP2.2, C201.2, C202.2, JP3.2, C301.2, C302.2, JP4.2, C401.2, C402.2, JP5.2, C501.2, C502.2, JP6.2, U1.GND, U2.GND, U3.GND, U4.GND, U5.GND, RP1.2, RP2.2, RP3.2, RP4.2, RP5.2, RP6.2, RP7.2, RP8.2, RP9.2, RP10.2, RP11.2, TP34.1 |
| `GND` | 15 | J6.4, C1.2, C2.2, J2.2, J7.1, A1.GND, JP1.2, J5.0, J5.8, J1.0, J1.8, A-J3.0, A-J3.1, B-J4.0, TP33.1 |
| `MEGA_5V` | 7 | A1.5V, U1.VDD, U2.VDD, U3.VDD, U4.VDD, U5.VDD, TP32.1 |
| `amp shutdown` | 3 | A1.D2, RS1.1, TP30.1 |
| `analyser/reset` | 7 | A1.D3, U1.RESET, U2.RESET, U3.RESET, U4.RESET, U5.RESET, TP21.1 |
| `analyser/strobe` | 7 | A1.D4, U1.STROBE, U2.STROBE, U3.STROBE, U4.STROBE, U5.STROBE, TP20.1 |
| `centre/spare1` | 2 | B-J4.7, Extra3.1 |
| `dxl_data` | 5 | M1.data, J7.3, J5.14, J1.14, A-J3.10 |
| `female1/analyser out` | 3 | U1.OUT, A1.A0, TP11.1 |
| `female1/audio return` | 2 | J5.4, JP2.1 |
| `female1/filter mid` | 3 | R101.2, C101.1, R102.1 |
| `female1/filter out` | 4 | R102.2, C102.1, R103.1, TP1.1 |
| `female1/line out` | 2 | J5.12, R103.2 |
| `female1/microphone` | 2 | J5.6, U1.IN |
...
| `female1/tone` | 2 | A1.D11, R101.1 |
| `female2/analyser out` | 3 | U2.OUT, A1.A1, TP12.1 |
| `female2/audio return` | 2 | J1.4, JP3.1 |
| `female2/filter mid` | 3 | R201.2, C201.1, R202.1 |
| `female2/filter out` | 4 | R202.2, C202.1, R203.1, TP2.1 |
| `female2/line out` | 2 | J1.12, R203.2 |
| `female2/microphone` | 2 | J1.6, U2.IN |
...
| `female2/tone` | 2 | A1.D5, R201.1 |
| `female3/analyser out` | 3 | U3.OUT, A1.A2, TP13.1 |
| `female3/audio return` | 2 | A-J3.5, JP4.1 |
| `female3/filter mid` | 3 | R301.2, C301.1, R302.1 |
| `female3/filter out` | 4 | R302.2, C302.1, R303.1, TP3.1 |
| `female3/line out` | 2 | A-J3.12, R303.2 |
| `female3/microphone` | 2 | A-J3.3, U3.IN |
| `female3/neopixel` | 2 | A-J3.11, RN3.2 |
| `female3/neopixel/driven` | 2 | A1.D8, RN3.1 |
| `female3/photosensor` | 3 | A-J3.4, A1.A7, RP3.1 |
| `female3/tone` | 2 | A1.D6, R301.1 |
| `male1/analyser out` | 3 | U4.OUT, A1.A3, TP14.1 |
| `male1/audio return` | 2 | B-J4.2, JP5.1 |
...
| `male1/filter mid` | 3 | R401.2, C401.1, R402.1 |
| `male1/filter out` | 4 | R402.2, C402.1, R403.1, TP4.1 |
| `male1/line out` | 2 | B-J4.9, R403.2 |
| `male1/microphone` | 2 | A-J3.13, U4.IN |
...
| `male1/tone` | 2 | A1.D46, R401.1 |
| `male2/analyser out` | 3 | U5.OUT, A1.A4, TP15.1 |
| `male2/audio return` | 2 | B-J4.14, JP6.1 |
...
| `male2/filter mid` | 3 | R501.2, C501.1, R502.1 |
| `male2/filter out` | 4 | R502.2, C502.1, R503.1, TP5.1 |
| `male2/line out` | 2 | B-J4.6, R503.2 |
| `male2/microphone` | 2 | B-J4.10, U5.IN |
