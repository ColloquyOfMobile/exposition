...
from .build_child import child_as_iframe, as_value, build_child
...
def children(child, app_href, iframe_href, focus):
    doc, tag, text = Doc().tagtext()  
    ...
    with tag("div", name="children", style=build_css(css)):
        ...
        for _nickname in sorted(children):
            child = children[_nickname]  
            ...
            if "children" in child:                        
                ...
                doc.asis(as_value(nickname=_nickname, child=child)) 
