...
def build_html(ui, app_href, iframe_href):    
    ...
    with tag("html", style=build_css(css_style)):
        doc.asis(head())
        doc.asis(body(ui=ui, app_href=app_href, iframe_href=iframe_href))
...
def body(ui, app_href, iframe_href):        
    ...
    with tag("body", style=build_css(css_style)):
        ...
        doc.asis(notes())
        doc.asis(from_dict(ui=ui, app_href=app_href, iframe_href=iframe_href))
