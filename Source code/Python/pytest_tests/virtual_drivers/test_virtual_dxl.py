"""Unit tests for colloquy.virtual_drivers.virtual_dxl.VirtualDXL - the
...
from colloquy.virtual_drivers.virtual_dxl import VirtualDXL
...
def test_set_goal_position_reuses_existing_thread_while_alive(stub_factory, monkeypatch):
    ...
    monkeypatch.setattr("colloquy.virtual_drivers.virtual_dxl.Thread", FakeThread)
