"""Unit tests for colloquy.hardware.angle.Angle - the node that lets every
...
def test_the_page_shows_both_the_angle_and_what_the_servo_reads(stub_factory):
    ...
    states = angle._snapshot_if_opened(("hardware", "female1", "angle"))
...
def test_the_jog_commands_on_the_page_actually_move_the_body(stub_factory):
    ...
    states = angle._snapshot_if_opened(("hardware", "male1", "angle"))
    states["turn +10"]()
