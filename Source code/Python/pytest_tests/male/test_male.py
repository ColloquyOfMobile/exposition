...
def make_satisfaction_male(o_value, p_value):
...
def test_is_satisfied_true_only_when_both_appetites_are_below_the_floor():
    ...
    fake = make_satisfaction_male(0, 0)
...
def test_one_full_appetite_is_not_satisfied():
    ...
    """
    assert make_satisfaction_male(200, 0).drives.which_is_frustated() == ("O",)

    assert Male.is_satisfied(make_satisfaction_male(200, 0)) is False
    assert Male.is_satisfied(make_satisfaction_male(0, 200)) is False
...
def test_a_half_risen_appetite_is_not_satisfied_either():
    ...
    fake = make_satisfaction_male(100, 0)
...
def test_is_satisfied_false_when_both_appetites_are_up():
    fake = make_satisfaction_male(200, 200)
