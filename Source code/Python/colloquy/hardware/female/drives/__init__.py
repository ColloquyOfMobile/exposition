...
def build_map_to_compensate_brightness_to_human_eye():
    map_from_tj = (4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 16, 16, 16, 16, 16, 16, 16, 16, 20, 20, 20, 20, 20, 20, 20, 20, 24, 24, 24, 24, 24, 24, 24, 28, 28, 28, 28, 28, 28, 32, 32, 32, 32, 32, 32, 36, 36, 36, 36, 36, 40, 40, 40, 40, 40, 40, 44, 44, 44, 44, 44, 48, 48, 48, 48, 52, 52, 52, 52, 52, 56, 56, 56, 56, 60, 60, 60, 60, 64, 64, 64, 64, 68, 68, 68, 68, 72, 72, 72, 72, 76, 76, 76, 76, 80, 80, 80, 80, 84, 84, 84, 88, 88, 88, 88, 92, 92, 92, 96, 96, 96, 100, 100, 100, 104, 104, 104, 104, 108, 108, 108, 112, 112, 112, 116, 116, 116, 120, 120, 120, 124, 124, 124, 128, 128, 128, 132, 132, 136, 136, 136, 140, 140, 140, 144, 144, 148, 148, 148, 152, 152, 152, 156, 156, 160, 160, 160, 164, 164, 168, 168, 168, 172, 172, 176, 176, 176, 180, 180, 184, 184, 184, 188, 188, 192, 192, 196, 196, 200, 200, 200, 204, 204, 208, 208, 212, 212, 216, 216, 216, 220, 220, 224, 224, 228, 228, 232, 232, 236, 236, 240, 240, 244, 244, 248, 248, 252, 252, 255, 255)
...
class Drives(BaseThread):
    ...
    def __init__(self, owner):
        ...
        self._map_to_compensate_brightness_to_human_eye = build_map_to_compensate_brightness_to_human_eye()
    ...
    def update(self):
        ...
        female.neopixels.body_o.brightness.value = self.compensate_brightness_for_human_eye(o_value)
        female.neopixels.body_p.brightness.value = self.compensate_brightness_for_human_eye(p_value)
        if o_value < p_value:
