...
class MaleToggleDriveNeopixel(ToggleNeopixel):
    def __init__(self, owner, body):
        ToggleNeopixel.__init__(
            self, owner, body, name=f"{body.name}/body/drive/toggle"
        )
    ...
    def write_html(self):
        ...
        with tag(
            ...
            doc.stag(
                ...
                type="color",
                name="hex_rgb",
                value=self.rgb_to_hex(red, green, blue),
            )
...
class FemaleConfigureNeopixel(ConfigureNeopixel):
    def __init__(self, owner, body):
        ConfigureNeopixel.__init__(
            self, owner, body, name=f"{body.name}/neopixel/configure"
        )
...
class MaleConfigureUpRingNeopixel(ConfigureNeopixel):
    def __init__(self, owner, body):
        ConfigureNeopixel.__init__(
            self, owner, body, name=f"{body.name}/UpRing/configure"
        )
...
class MaleConfigureDriveNeopixel(ConfigureNeopixel):
    def __init__(self, owner, body):
        ConfigureNeopixel.__init__(
            self, owner, body, name=f"{body.name}/body/drive/configure"
        )
...
class MaleConfigureRingNeopixel(ConfigureNeopixel):
    def __init__(self, owner, body):
        ConfigureNeopixel.__init__(
            self, owner, body, name=f"{body.name}/body/ring/configure"
        )
